...
namespace ClearTheStockpiles
{
	...
	internal class CTS_Loader : Mod
	{
		...
		public override void DoSettingsWindowContents(Rect inRect)
		{
			...
			listing_Standard.Label(Translator.Translate("CTS_LookRadiusLabel"), -1f, null);
			listing_Standard.TextFieldNumeric(ref settings.radiusToSearch, ref text, 1f, 25f);
			listing_Standard.Gap(12f);
			listing_Standard.CheckboxLabeled(Translator.Translate("CTS_Debug"), ref settings.debug, null);
